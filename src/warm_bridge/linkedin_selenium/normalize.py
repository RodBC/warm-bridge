"""Map scrape rows → Warm Bridge contact dicts (via contact_from_fields)."""
...
def mutual_row_to_contact(
    ...
    *,
    ...
    """One observed mutual → contact. Notes carry explicit mutual marker for scoring."""
    ...
    contact = contact_from_fields(
        name=name,
        company=company,
        title=title,
        notes=notes,
        sources=["linkedin_selenium"],
        strength=strength,
        linkedin_url=url,
